import { agregarCliente, insertarDireccion } from './crudClientes.js';
import { toastInfo } from '../funciones/alertas.js';
import { mostrarAlertaClienteGuardado, mostrarErrorValidacion, mostrarErrorServidor, mostrarCambiosSinGuardar, mostrarErrorProcesar } from './alertaClientes.js';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formulario.addEventListener('submit', async function(e) {
        ...
        try { 
            ...
            toastInfo('Procesando', 'Guardando datos del Cliente...');
